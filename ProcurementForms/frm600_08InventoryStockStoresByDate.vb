...
Public Class frm600_08InventoryStockStoresByDate
    Public frm600_08InventoryStockStoresByDateIsClosed As Boolean
    ...
    Private Sub frm600_08InventoryStockStoresByDate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'Dsfrm600_08InventoryStoreSummaryByDate.qry654_03StoreStockBalanceMasterByDate' table. You can move, or remove it, as needed.
...
#Region "Calendar Controls Code"
    Public Sub RetrieveVoucher(ByVal StartDate As Date, ByVal EndDate As Date)
        Try
            ...
            Me.InsertStoreInventoryValueByDate(StartDate, EndDate.AddHours(23))

            Me.Qry654_03StoreStockBalanceMasterByDateTableAdapter.Fill(Me.Dsfrm600_08InventoryStoreSummaryByDate.qry654_03StoreStockBalanceMasterByDate)
    ...
    Private Sub InsertStoreInventoryValueByDate(ByVal StartDate As Date, ByVal EndDate As Date)
...
#End Region
    ...
    Private Sub frm601_22InventoryByDate_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.frm600_08InventoryStockStoresByDateIsClosed = True
    End Sub
    ...
    Private Sub frm20172VATInvoiceWithDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LoadLayoutFromDB(Me.intLogOnUserID, "frm600_08InventoryStockStoresByDate", Me.gvAdvBandedInvoiceView)
    ...
    Private Sub btnSetAsDefaultLayout_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnSetDefaultLayout.ItemClick
        ...
        Try
            Dim formID As String = "frm600_08InventoryStockStoresByDate"
    ...
    Private Sub btnTransactionReport_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnTransactionReport.ItemClick
        Try
            Dim rpt1 As New rpt602_InventoryWithTransaction
            ...
            rpt1.Qry664_MTL_StockMaster_AvgCost03_WtDetailTableAdapter.FillByTransactionDate(rpt1.DsRpt602_InventoryWithTransaction1.qry664_MTL_StockMaster_AvgCost03_WtDetail, Me.txtEndDate.EditValue)
            rpt1.paramPeriod.Value = " as of " & Format(Me.txtEndDate.EditValue, "dd-MMM-yyyy")

            rpt1.ExportOptions.PrintPreview.DefaultFileName = "Stock Inventory - Transaction Report as of " & Format(Me.txtEndDate.EditValue, "dd-MMM-yyyy")
            rpt1.ShowPreview()
        Catch ex As Exception
