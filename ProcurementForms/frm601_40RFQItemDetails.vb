...
Public Class frm601_40RFQItemDetails
    Public frm601_40RFQItemDetailsIsClosed As Boolean
    ...
    Public Sub RetrieveVoucher(ByVal StartDate As Date, ByVal EndDate As Date)
        Try
            If intLogOnInventoryMPRAccessLevel = 99 Then
                Me.Qry607_06RFQDetailsTableAdapter.FillByDate(Me.Dsfrm601_40RFQItemDetails.qry607_06RFQDetails, StartDate, EndDate)
            Else
                Me.Qry607_06RFQDetailsTableAdapter.FillByDateBySalesPersonUserID(Me.Dsfrm601_40RFQItemDetails.qry607_06RFQDetails, StartDate, EndDate, Me.intLogOnUserID)
            End If


        Catch ex As Exception
            MessageBox.Show("Error on Retrieving RFQ Item Details.", "Error Occured", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
...
#End Region
    ...
    Private Sub frm601_14DeliveryDetails_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.frm601_40RFQItemDetailsIsClosed = True
    End Sub
    ...
    Private Sub frm20172VATInvoiceWithDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LoadLayoutFromDB(Me.intLogOnUserID, "frm601_40RFQItemDetails", Me.gvAdvBandedQuotationView)
    ...
    Private Sub btnSetAsDefaultLayout_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnSetDefaultLayout.ItemClick
        ...
        Try
            Dim formID As String = "frm601_40RFQItemDetails"
