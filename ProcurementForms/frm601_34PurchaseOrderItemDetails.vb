...
Public Class frm601_34PurchaseOrderItemDetails
    Public frm601_34PurchaseOrderItemDetailsIsClosed As Boolean
        ...
        Try
            If intLogOnInventoryAccessLevel = 99 Then
                If Me.intLogOnInventoryMPRAccessLevel = 99 Then
                    Me.Qry604_10PurchaseItemDetailsTableAdapter.FillByDate(Me.Dsfrm601_34PurchaseOrderItemDetails.qry604_10PurchaseItemDetails, StartDate, EndDate)
                Else
                    Me.Qry604_10PurchaseItemDetailsTableAdapter.FillByDateBySalesPersonUserID(Me.Dsfrm601_34PurchaseOrderItemDetails.qry604_10PurchaseItemDetails, StartDate, EndDate, Me.intLogOnUserID)
                End If

            Else
                If Me.intLogOnInventoryMPRAccessLevel = 99 Then
                    Me.Qry604_10PurchaseItemDetailsTableAdapter.FillByDateByGroup(Me.Dsfrm601_34PurchaseOrderItemDetails.qry604_10PurchaseItemDetails, StartDate, EndDate, Me.intLogOnInventoryAccessLevel)
                Else
                    Me.Qry604_10PurchaseItemDetailsTableAdapter.FillByDateByGroupBySalesPersonUserID(Me.Dsfrm601_34PurchaseOrderItemDetails.qry604_10PurchaseItemDetails, StartDate, EndDate, Me.intLogOnInventoryAccessLevel, Me.intLogOnUserID)
                End If

            End If

        Catch ex As Exception
            MessageBox.Show("Error on Retrieving Purchase Order Item Details.", "Error Occured", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
...
#End Region
    ...
    Private Sub frm601_14DeliveryDetails_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.frm601_34PurchaseOrderItemDetailsIsClosed = True
    End Sub
    ...
    Private Sub frm20172VATInvoiceWithDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LoadLayoutFromDB(Me.intLogOnUserID, "frm601_34PurchaseOrderItemDetails", Me.gvAdvBandedQuotationView)
    ...
    Private Sub btnSetAsDefaultLayout_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnSetDefaultLayout.ItemClick
        ...
        Try
            Dim formID As String = "frm601_34PurchaseOrderItemDetails"
