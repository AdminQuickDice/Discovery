...
Public Class frm601_33QuotationDetails
    Public frm601_33QuotationDetailsIsClosed As Boolean
        ...
        Try
            If intLogOnInventoryAccessLevel = 99 Then
                If Me.intLogOnInventoryMPRAccessLevel = 99 Then
                    Me.Qry601_24QuotationItemDetailsTableAdapter.FillByDate(Me.DsFrm601_33QuotationDetails.qry601_24QuotationItemDetails, StartDate, EndDate)
                Else
                    Me.Qry601_24QuotationItemDetailsTableAdapter.FillByDateBySalesPersonUserID(Me.DsFrm601_33QuotationDetails.qry601_24QuotationItemDetails, StartDate, EndDate, Me.intLogOnUserID)
                End If

            Else
                If Me.intLogOnInventoryMPRAccessLevel = 99 Then
                    Me.Qry601_24QuotationItemDetailsTableAdapter.FillByDateByGroup(Me.DsFrm601_33QuotationDetails.qry601_24QuotationItemDetails, StartDate, EndDate, Me.intLogOnInventoryAccessLevel)
                Else
                    Me.Qry601_24QuotationItemDetailsTableAdapter.FillByDateByGroupBySalesPersonUserID(Me.DsFrm601_33QuotationDetails.qry601_24QuotationItemDetails, StartDate, EndDate, Me.intLogOnInventoryAccessLevel, Me.intLogOnUserID)
                End If

            End If
        Catch ex As Exception
            MessageBox.Show("Error on Retrieving Quotation Item Details.", "Error Occured", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
...
#End Region
    ...
    Private Sub frm601_14DeliveryDetails_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.frm601_33QuotationDetailsIsClosed = True
    End Sub
    ...
    Private Sub frm20172VATInvoiceWithDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LoadLayoutFromDB(Me.intLogOnUserID, "frm601_33QuotationDetails", Me.gvAdvBandedQuotationView)
    ...
    Private Sub btnSetAsDefaultLayout_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnSetDefaultLayout.ItemClick
        ...
        Try
            Dim formID As String = "frm601_33QuotationDetails"
