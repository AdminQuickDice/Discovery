...
Public Class frm601_35PurchaseRequestItemDetails
    Public frm601_35PurchaseRequestItemDetailsIsClosed As Boolean
        ...
        Try
            If intLogOnInventoryAccessLevel = 99 Then
                If intLogOnInventoryMPRAccessLevel = 99 Then
                    Me.Qry606_09PurchaseRequestItemDetailsTableAdapter.FillByDate(Me.Dsfrm601_35PurchaseRequestItemDetails.qry606_09PurchaseRequestItemDetails, StartDate, EndDate)
                Else
                    Me.Qry606_09PurchaseRequestItemDetailsTableAdapter.FillByDateBySalesPersonUserID(Me.Dsfrm601_35PurchaseRequestItemDetails.qry606_09PurchaseRequestItemDetails, StartDate, EndDate, Me.intLogOnUserID)
                End If


            Else
                If intLogOnInventoryMPRAccessLevel = 99 Then
                    Me.Qry606_09PurchaseRequestItemDetailsTableAdapter.FillByDateByGroup(Me.Dsfrm601_35PurchaseRequestItemDetails.qry606_09PurchaseRequestItemDetails, StartDate, EndDate, Me.intLogOnInventoryAccessLevel)
                Else
                    Me.Qry606_09PurchaseRequestItemDetailsTableAdapter.FillByDateByGroupBySalesPersonUserID(Me.Dsfrm601_35PurchaseRequestItemDetails.qry606_09PurchaseRequestItemDetails, StartDate, EndDate, Me.intLogOnInventoryAccessLevel, Me.intLogOnUserID)
                End If

            End If
        Catch ex As Exception
            MessageBox.Show("Error on Retrieving Purchase Request / Client Enquiry Item Details.", "Error Occured", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
...
#End Region
    ...
    Private Sub frm601_14DeliveryDetails_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.frm601_35PurchaseRequestItemDetailsIsClosed = True
    End Sub
    ...
    Private Sub frm20172VATInvoiceWithDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LoadLayoutFromDB(Me.intLogOnUserID, "frm601_35PurchaseRequestItemDetails", Me.gvAdvBandedQuotationView)
    ...
    Private Sub btnSetAsDefaultLayout_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnSetDefaultLayout.ItemClick
        ...
        Try
            Dim formID As String = "frm601_35PurchaseRequestItemDetails"
