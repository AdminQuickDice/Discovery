...
Public Class rpt604_01IncomingInspectionReport
    ...
    Private Sub rpt602_01ReceivedCondition_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        ...
        Catch ex As Exception
            MessageBox.Show("Failed to load document, Please try again.", "Loading Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
End Class