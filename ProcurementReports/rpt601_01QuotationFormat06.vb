...
Public Class rpt601_01QuotationFormat06
    ...
    Private Sub rpt601_01QuotationFormat06_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        Try
            GetCompanySealImage()
            'Get Print Margins
            GetReportDetails("IMS-QTN-08")
